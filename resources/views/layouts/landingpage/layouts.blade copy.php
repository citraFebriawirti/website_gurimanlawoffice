...
<head>
  ...
  <style>
    ...
    .header-sticky {
      ...
      position: sticky;
      /* memastikan header tetap sticky saat scroll */
      top: 0;
      /* memastikan sticky header tetap berada di atas */
      z-index: 99999;
      /* memastikan header sticky tetap berada di atas elemen lainnya */
    }

    /* Menyembunyikan header saat scroll ke bawah */
    .sticky-hidden {
      top: -100px;
      /* Menyembunyikan header dengan cara menggesernya ke atas */
      transition: top 0.3s;
    ...
    @media (max-width: 767px) {
      .select-container {
        margin-top: 10px;
        /* Space between menu and select */
        text-align: center;
        /* Center the select on mobile */
      }
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-3">
                <div class="header-logo">
                  <img src=" {{ asset('landingpage/assets/img/logo/logo.png?v=1') }}" alt="Logo" style="width: 90px" />
                </div>
              </div>
              <!-- Header Logo End -->
                ...
                <div class="header-menu-area">
                  <nav>
                    <ul class="main-menu d-flex justify-content-between">
                      ...
                      <li class="{{ Request::routeIs('productlandingpage') ? 'active' : '' }}"><a href="{{ route('productlandingpage') }}">PRODUCT</a></li>
                      <li class="{{ Request::routeIs('teamlandingpage') ? 'active' : '' }}"><a href="{{ route('teamlandingpage') }}">TEAM WORK</a></li>
