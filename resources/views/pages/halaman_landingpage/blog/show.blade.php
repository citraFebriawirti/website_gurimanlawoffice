                            ...
                            <li class="d-flex">
                                <div class="rc-post-thumb" >
                                    <a href="{{ route('bloglandingpage.show', $recent->id_artikel) }}">
                                        <img src="{{ asset($recent->image_artikel) }}" alt="{{ $recent->title_artikel }}" 
                                ...
                                <div class="rc-post-content">
                                    <div class="widget-date">{{ Carbon\Carbon::parse($recent->created_at)->format('d M Y') }}</div>
                                    <h4>
                                        <a href="{{ route('bloglandingpage.show', $recent->id_artikel) }}">{{ $recent->title_artikel }}</a>
                                    </h4>
                                </div>
                            </li>
                            @endforeach
