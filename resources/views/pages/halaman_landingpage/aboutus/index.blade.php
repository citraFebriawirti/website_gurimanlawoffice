            ...
            <div class="single-service-content">
              ...
              <div class="single-service-working d-flex mb-20">
                ...
                <div class="service-working-content mb-20">
                  <h5>Vision</h5>
                  <p>The vision of Gumiran Law Office can be seen :</p>
              ...
              <div class="single-service-working d-flex mb-20">
                ...
                <div class="service-working-content mb-20">
                  <h5>Mission</h5>
                  <p>The mission of Gumiran Law Office can be seen :</p>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="section-title text-center mb-70">
            ...
            <h2>Legality</h2>
            <p>Gumiran Law is an official law firm that operates in accordance with Indonesian regulations, has clear legality, a valid practice permit, and is committed to professionalism and an advocate's code of ethics to provide trusted legal services.</p>
          </div>
          <!--Section Title End-->
        </div>
      </div>
          ...
          <div class="single-service mb-30">
            <div class="single-service-img img-full">
              <a href="{{ asset($datalegalitas->image_legalitas) }}" target="_blank">
                  <iframe src="{{ asset($datalegalitas->image_legalitas) }}" width="100%" height="500px" style="border: none;"></iframe>
              </a>
          </div>
