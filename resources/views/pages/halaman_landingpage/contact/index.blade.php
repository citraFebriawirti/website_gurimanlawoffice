                    ...
                    <div class="contact-information">
                        <ul>
                            ...
                            <li>
                                ...
                                <p><a href="tel:+62{{ $dataPhone->no_phone }} ">{{ $dataPhone->no_phone }} </a><br>
                            ...
                            <li>
                                ...
                                @foreach ($email as $dataemail)
                                    ...
                                    <p><a href="#">{{ $dataemail->name_email }}</a>
