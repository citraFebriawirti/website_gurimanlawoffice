...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Data Address</li>
      </ol>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primaryy">Edit Data Address</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('address.update', $dataById->id_address) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row-container" data-row="1">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                          ...
                          name="title_address">{!! $dataById->title_address !!}</textarea><!-- End TinyMCE Editor -->
                     ...
                     <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                           ...
                           cols="30" rows="10" placeholder="text" onfocus="focused(this)" onfocusout="defocused(this')"
                           name="link_gmap_address">{!! $dataById->link_gmap_address !!}</textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            ...
                            class="form-control" @error('status_address') is-invalid bg-danger @enderror>
                                <option value="">pilih jenis status</option>
                                <option value="Aktif" @selected($dataById->status_address === 'Aktif')>Aktif</option>
                                <option value="Tidak Aktif" @selected($dataById->status_address === 'Tidak Aktif')>Tidak Aktif</option>
                            </select>
