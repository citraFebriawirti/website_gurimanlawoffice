                ...
                <form action="{{ route('hero.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row-container" data-row="1">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-9">
                                <!-- TinyMCE Editor -->
                                <textarea class="tinymce-editor @error('link_hero') is-invalid @enderror"
                                    name="link_hero" id="link_hero" cols="30" rows="10" placeholder="text"
                                    onfocus="focused(this)" onfocusout="defocused(this')" name="link_hero"></textarea>
                                <!-- End TinyMCE Editor -->
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-9">
                                <select name="status_hero" id="status_hero"
                                    ...
                                    <option value="Aktif" @selected(old('status_hero', $status_hero ?? '' )==='Aktif' )>
                                        Aktif</option>
                                    <option value="Tidak Aktif" @selected(old('status_hero', $status_hero ?? ''
