            ...
            <form action="{{ route('hero.update', $dataById->id_hero) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row-container" data-row="1">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            <!-- TinyMCE Editor -->
                            <textarea class="tinymce-editor @error('description_hero') is-invalid @enderror"
                                name="description_hero" id="description_hero" cols="30" rows="10" placeholder="text"
                                onfocus="focused(this)" onfocusout="defocused(this')"
                                name="description_hero">{!! $dataById->description_hero !!}</textarea>
                            <!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            <!-- TinyMCE Editor -->
                            <textarea class="tinymce-editor @error('link_hero') is-invalid @enderror" name="link_hero"
                                id="link_hero" cols="30" rows="10" placeholder="text" onfocus="focused(this)"
                                onfocusout="defocused(this')" name="link_hero">{!! $dataById->link_hero !!}</textarea>
                            <!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-2">
                            <label for="image_hero">Image <span style="color: red;font-size:12px">Size
                                    537x7990</span></label>
                        </div>
                        <div class="col-lg-9">
                            <input type="file" name="image_hero[]" id="image_hero" multiple accept=".jpg,.jpeg,.png"
                            ...
                            <img src="{{ asset($dataById->image_hero) }}" alt="Gambar Lama" class="img-thumbnail"
                                style="width: 200px;">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            <select name="status_hero" id="status_hero" class="form-control" @error('status_hero')
                                is-invalid bg-danger @enderror>
                                <option value="">pilih jenis status</option>
                                <option value="Aktif" @selected($dataById->status_hero === 'Aktif')>Aktif</option>
                                <option value="Tidak Aktif" @selected($dataById->status_hero === 'Tidak Aktif')>Tidak
                                    Aktif</option>
                            </select>
