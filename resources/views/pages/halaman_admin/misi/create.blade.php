  ...
  <div class="container-fluid" id="container-wrapper">
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primaryy">Tambah Data misi</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row-container" data-row="1">
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                             ...
                             name="title_misi"></textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            ...
                            class="form-control @error('status_misi') is-invalid @enderror">
                        <option value="">Pilih jenis status</option>
                        <option value="Aktif" @selected(old('status_misi', $status_misi ?? '') === 'Aktif')>Aktif</option>
                        <option value="Tidak Aktif" @selected(old('status_misi', $status_misi ?? '') === 'Tidak Aktif')>Tidak Aktif</option>
                    </select>
