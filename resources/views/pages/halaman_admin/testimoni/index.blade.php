    ...
    <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <a href="{{route('testimoni.create')}}" class="btn btn-success btn-icon-split">
            ...
            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
              ...
              <tbody>   
                ...
                <tr class="text-left">
                  ...
                  <td>{{ $data->position_testimoni }}</td>
                  <td>{!! $data->description_testimoni !!}</td>
  
                  <td scope="row" class="text-center">
                    <a href="{{ asset($data->image_testimoni) }}" target="_blank">
                        <img src="{{ asset($data->image_testimoni) }}" alt=""
                            class="img-fluid" style="width: 100px; height: 100px;">
                    </a>
                </td>
                  <td>{{ $data->status_testimoni }}</td>
                  <td class="text-center">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('testimoni.edit', $data->id_testimoni) }}"
                            class="btn btn-sm btn-primary m-1"><i class="fas fa-pencil-alt"></i></a>

                        <form action="{{ route('testimoni.destroy', $data->id_testimoni) }}" method="post">
                            @csrf
                            @method('delete')
