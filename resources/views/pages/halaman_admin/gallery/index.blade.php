    ...
    <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <a href="{{route('gallery.create')}}" class="btn btn-success btn-icon-split">
              ...
              <tbody>   
                ...
                <tr class="text-center">
                  ...
                  <td scope="row" class="text-center">
                    <a href="{{ asset($data->image_gallery) }}" target="_blank">
                        <img src="{{ asset($data->image_gallery) }}" alt=""
                            class="img-fluid" style="width: 100px; height: 100px;">
                    </a>
                </td>
                  <td>{{ $data->status_gallery }}</td>
                  <td class="text-center">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('gallery.edit', $data->id_gallery) }}"
                            class="btn btn-sm btn-primary m-1"><i class="fas fa-pencil-alt"></i></a>

                        <form action="{{ route('gallery.destroy', $data->id_gallery) }}" method="post">
                            @csrf
                            @method('delete')
