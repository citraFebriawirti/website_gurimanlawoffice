  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Data Legalitas</li>
      </ol>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primaryy">Tambah Data Legalitas</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row-container" data-row="1">
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control @error('title_legalitas') is-invalid @enderror"
                                value="{{ old('title_legalitas') }}" name="title_legalitas" id="title_legalitas">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                             ...
                             name="description_legalitas"></textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            ...
                            class="form-control @error('status_legalitas') is-invalid @enderror">
                        <option value="">Pilih jenis status</option>
                        <option value="Aktif" @selected(old('status_legalitas', $status_legalitas ?? '') === 'Aktif')>Aktif</option>
                        <option value="Tidak Aktif" @selected(old('status_legalitas', $status_legalitas ?? '') === 'Tidak Aktif')>Tidak Aktif</option>
                    </select>
