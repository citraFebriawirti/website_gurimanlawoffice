  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Legalitas</li>
      </ol>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <a href="{{route('legalitas.create')}}" class="btn btn-success btn-icon-split">
            ...
            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
              ...
              <tbody>   
                ...
                <tr class="text-center">
                  ...
                  <td>{{ $data->title_legalitas }}</td>
                  <td>{!! $data->description_legalitas !!}</td>
                  <td scope="row" class="text-center">
                    <a href="{{ asset($data->image_legalitas) }}" target="_blank">
                     

                            <iframe src="{{ asset($data->image_legalitas) }}" alt=""
                              class="img-fluid" 
                              style="width: 900px; background: #fff;">
                            </iframe>
                    </a>
                </td>
                  <td>{{ $data->status_legalitas }}</td>
                  <td class="text-center">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('legalitas.edit', $data->id_legalitas) }}"
                            class="btn btn-sm btn-primary m-1"><i class="fas fa-pencil-alt"></i></a>

                        <form action="{{ route('legalitas.destroy', $data->id_legalitas) }}" method="post">
                            @csrf
                            @method('delete')
