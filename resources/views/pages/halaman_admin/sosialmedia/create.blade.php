  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Data Sosial Media</li>
      </ol>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primaryy">Tambah Data Sosial Media</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row-container" data-row="1">
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                             ...
                             cols="5" rows="3" placeholder="text" onfocus="focused(this)" onfocusout="defocused(this')"
                             name="link_tiktok_sosialmedia"></textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                             ...
                             cols="5" rows="3" placeholder="text" onfocus="focused(this)" onfocusout="defocused(this')"
                             name="link_instagram_sosialmedia"></textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                             ...
                             cols="5" rows="3" placeholder="text" onfocus="focused(this)" onfocusout="defocused(this')"
                             name="link_youtube_sosialmedia"></textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                             ...
                             cols="5" rows="3" placeholder="text" onfocus="focused(this)" onfocusout="defocused(this')"
                             name="link_linkedin_sosialmedia"></textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            ...
                            class="form-control @error('status_sosialmedia') is-invalid @enderror">
                        <option value="">Pilih jenis status</option>
                        <option value="Aktif" @selected(old('status_sosialmedia', $status_sosialmedia ?? '') === 'Aktif')>Aktif</option>
                        <option value="Tidak Aktif" @selected(old('status_sosialmedia', $status_sosialmedia ?? '') === 'Tidak Aktif')>Tidak Aktif</option>
                    </select>
