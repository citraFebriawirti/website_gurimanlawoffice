    ...
    <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <a href="{{route('sosialmedia.create')}}" class="btn btn-success btn-icon-split">
            ...
            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
              ...
              <tbody>   
                ...
                <tr class="text-center">
                  ...
                  <td>{!! $data->link_tiktok_sosialmedia !!}</td>

                  <td>{!! $data->link_instagram_sosialmedia !!}</td>

                  <td>{!! $data->link_youtube_sosialmedia !!}</td>

                  <td>{!! $data->link_linkedin_sosialmedia !!}</td>
            
                  <td>{{ $data->status_sosialmedia }}</td>
                  <td class="text-center">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('sosialmedia.edit', $data->id_sosialmedia) }}"
                            class="btn btn-sm btn-primary m-1"><i class="fas fa-pencil-alt"></i></a>

                        <form action="{{ route('sosialmedia.destroy', $data->id_sosialmedia) }}" method="post">
                            @csrf
                            @method('delete')
