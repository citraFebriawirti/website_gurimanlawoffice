  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Email</li>
      </ol>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Data Email</h6>
            <a href="{{route('email.create')}}" class="btn btn-success btn-icon-split">
                ...
                <tr class="text-center">
                  ...
                  <td class="text-center">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('email.edit', $data->id_email) }}"
                            class="btn btn-sm btn-primary m-1"><i class="fas fa-pencil-alt"></i></a>

                        <form action="{{ route('email.destroy', $data->id_email) }}" method="post">
                            @csrf
                            @method('delete')
