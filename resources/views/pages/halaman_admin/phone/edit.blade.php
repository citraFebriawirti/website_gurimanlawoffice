...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Data Phone</li>
      </ol>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primaryy">Edit Data Phone</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('phone.update', $dataById->id_phone) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row-container" data-row="1">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            ...
                            value="{{ old('no_phone') ?? $dataById->no_phone }}" 
                            name="no_phone" 
                            id="inputNanme4"
                            pattern="^08[0-9]{8,11}$"
                            maxlength="13"
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            ...
                            class="form-control" @error('status_phone') is-invalid bg-danger @enderror>
                                <option value="">pilih jenis status</option>
                                <option value="Aktif" @selected($dataById->status_phone === 'Aktif')>Aktif</option>
                                <option value="Tidak Aktif" @selected($dataById->status_phone === 'Tidak Aktif')>Tidak Aktif</option>
                            </select>
