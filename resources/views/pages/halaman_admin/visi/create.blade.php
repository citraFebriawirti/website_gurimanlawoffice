  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Data visi</li>
      </ol>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primaryy">Tambah Data Visi</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row-container" data-row="1">
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                             ...
                             name="title_visi"></textarea><!-- End TinyMCE Editor -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-9">
                            ...
                            class="form-control @error('status_visi') is-invalid @enderror">
                        <option value="">Pilih jenis status</option>
                        <option value="Aktif" @selected(old('status_visi', $status_visi ?? '') === 'Aktif')>Aktif</option>
                        <option value="Tidak Aktif" @selected(old('status_visi', $status_visi ?? '') === 'Tidak Aktif')>Tidak Aktif</option>
                    </select>
