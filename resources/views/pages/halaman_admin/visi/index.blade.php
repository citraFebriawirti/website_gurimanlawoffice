  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data visi</li>
      </ol>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <a href="{{route('visi.create')}}" class="btn btn-success btn-icon-split">
            ...
            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
              ...
              <tbody>   
                ...
                <tr class="text-center">
                  ...
                  <td>{!! $data->title_visi !!}</td>
                 
                
                
                
                  <td>{{ $data->status_visi }}</td>
                  <td class="text-center">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('visi.edit', $data->id_visi) }}"
                            class="btn btn-sm btn-primary m-1"><i class="fas fa-pencil-alt"></i></a>

                        <form action="{{ route('visi.destroy', $data->id_visi) }}" method="post">
                            @csrf
                            @method('delete')
